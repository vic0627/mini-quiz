...
<template>
  <div
    ...
    class="max-md:hidden fixed top-20 left-5 border-1 border-gray-600 rounded-xl backdrop-blur-2xl p-5 grid grid-cols-3 gap-3 lg:grid-cols-4 xl:grid-cols-5"
  >
    <el-button
